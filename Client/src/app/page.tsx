...
const howItWorks = [
  {
    ...
    icon: "📝",
    title: "Register",
    desc: "Sign up with your company details. Admin will provide your login credentials via WhatsApp.",
  },
  {
    step: "02",
    icon: "🎨",
  ...
  },
  {
    ...
    icon: "📦",
    title: "Place Order",
    desc: "Configure your order — quantity, paper type, finish — and send it to admin for confirmation.",
  },
  {
    step: "04",
    icon: "🚚",
            ...
            >
              ...
              <div className="p-4 sm:p-6">
                ...
                <div className="flex gap-1 sm:gap-2 items-center mt-3 text-[color:var(--text-dark)]">
                  <span className="text-[1.05rem] sm:text-[1.25rem]">🖨️</span>
        ...
        <div className="max-w-full sm:max-w-[1100px] mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
            {howItWorks.map((step) => (
              ...
              >
                <div className="w-[52px] h-[52px] sm:w-[60px] sm:h-[60px] md:w-[72px] md:h-[72px] rounded-full bg-gradient-to-br from-[#e1effe] to-[#c7d9fd] flex items-center justify-center text-[1.4rem] sm:text-[1.7rem] md:text-[2rem] mx-auto mb-3 sm:mb-4 shadow-md">
                  {step.icon}
                </div>
